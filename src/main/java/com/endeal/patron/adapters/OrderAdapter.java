...
public class OrderAdapter extends RecyclerView.Adapter<OrderViewHolder>
{
    ...
    public void onBindViewHolder(OrderViewHolder orderViewHolder, int position)
    {
        ...
        {
            color = R.color.returned;
            orderViewHolder.getStatus().setImageResource(R.drawable.ic_error_black_48dp);
        }
        orderViewHolder.getStatus().getDrawable().setColorFilter(new PorterDuffColorFilter(context.getResources().getColor(color), Mode.SRC_ATOP));
